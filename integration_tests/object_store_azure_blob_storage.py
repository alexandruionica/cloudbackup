...
class TestObjectStoreAzureBlobStorage(unittest.TestCase):
    def setUp(self):
        ...
        self.server_config_file_path, self.to_delete = setup_tmp_config_file_and_tmp_dirs(
            suffix='_integration_tests_object_store_azure_blob_storage_')
        # client - config file
    ...
    # incorrect credentials for Azure Blob
    ...
    def test_full_backup(self):
        ...
        self.assertIsNotNone(azure_storage_account_key, "Environment variable CLD_AZURE_STORAGE_ACCESS_KEY is not set")
...
def main():
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(TestObjectStoreAzureBlobStorage)
