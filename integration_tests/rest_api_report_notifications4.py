...
class TestRestAPIReportNotification4(unittest.TestCase):
    def setUp(self):
    ...
    # start a backup, wait for it to fail and then check notification
    def test_notification_for_failed_backup1(self):
...
def main():
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(TestRestAPIReportNotification4)
