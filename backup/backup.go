...
func Do(ctx context.Context, path string, stat os.FileInfo, backupConfig shared.ConfigBackup, dbData shared.DbData,
...
// return values: bool with true if backup got cancelled, false otherwise ; error if error encountered
func backupExistingWithMetadataChange(ctx context.Context, path string, stat os.FileInfo, backupConfig shared.ConfigBackup, dbData shared.DbData,
...
// return values: bool with true if backup got cancelled, false otherwise ; error if error encountered
func backupExistingWithContentChange(ctx context.Context, path string, stat os.FileInfo, backupConfig shared.ConfigBackup, dbData shared.DbData,
	objectStores []objectstore.ObjectStore, backupJobsState shared.BackupJobsStateInterface, updatedDbRecord shared.BackedUpFileProperties, jobUuid string) (bool, error) {
...
// return values: bool with true if backup got cancelled, false otherwise ; error if error encountered
func backupNewItem(ctx context.Context, path string, stat os.FileInfo, backupConfig shared.ConfigBackup, dbData shared.DbData,
	objectStores []objectstore.ObjectStore, backupJobsState shared.BackupJobsStateInterface, jobUuid string) (bool, error) {
	var err error
...
func UploadAndUpdateDB(operation string, ctx context.Context, path string, stat os.FileInfo, backupConfig shared.ConfigBackup, dbData shared.DbData,
...
func PrepareFileRecord(path string, stat os.FileInfo, backupConfig shared.ConfigBackup, ctime time.Time, checksum string, jobUuid string) (shared.BackedUpFileProperties, error) {
	var err error
...
func FindAndMarkDeleted(ctx context.Context, backupConfig shared.ConfigBackup, dbData shared.DbData,
...
func markDeleted(ObjectDbRecord shared.BackedUpFileProperties, backupConfig shared.ConfigBackup, dbData shared.DbData,
	objectStores []objectstore.ObjectStore, backupJobsState shared.BackupJobsStateInterface, jobUuid string) (bool, error) {
